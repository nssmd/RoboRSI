...
from roborsi.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from roborsi.agent.tools.registry import ToolRegistry
from roborsi.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("roborsi.agent.tools.mcp.logger.warning", _warning)
