...
category: control
version: 0.1.0
description: Nudge the end-effector by a small world-frame offset [dx, dy, dz] from its current position (closed-loop to current+delta). Use for fine corrections.
args:
  dpos:    { type: list, required: true, description: "World-frame offset [dx, dy, dz] in meters." }
