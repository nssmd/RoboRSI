...
- Benchmark task: `libero_object/8`
- Parent task family: `libero_pick_place`
- Visible instruction: Pick up the chocolate pudding and place it in the basket.
