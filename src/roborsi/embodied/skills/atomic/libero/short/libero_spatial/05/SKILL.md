...
- Benchmark task: `libero_spatial/5`
- Parent task family: `libero_pick_place`
- Visible instruction: Pick up the black bowl on the ramekin and place it on the plate.
