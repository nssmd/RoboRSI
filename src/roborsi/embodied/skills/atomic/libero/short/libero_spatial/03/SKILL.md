...
- Benchmark task: `libero_spatial/3`
- Parent task family: `libero_pick_place`
- Visible instruction: Pick up the black bowl on the cookie box and place it on the plate.
