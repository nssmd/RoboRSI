...
- Benchmark task: `libero_spatial/8`
- Parent task family: `libero_pick_place`
- Visible instruction: Pick up the black bowl next to the plate and place it on the plate.
