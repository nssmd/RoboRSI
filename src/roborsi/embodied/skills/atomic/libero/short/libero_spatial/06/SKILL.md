...
- Benchmark task: `libero_spatial/6`
- Parent task family: `libero_pick_place`
- Visible instruction: Pick up the black bowl next to the cookie box and place it on the plate.
