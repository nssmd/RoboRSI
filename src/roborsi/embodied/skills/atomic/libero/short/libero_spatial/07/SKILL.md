...
- Benchmark task: `libero_spatial/7`
- Parent task family: `libero_pick_place`
- Visible instruction: Pick up the black bowl on the stove and place it on the plate.
