...
domain: manipulation
version: 0.1.0
description: Put the ketchup in the top drawer of the cabinet.
metadata:
...
- Benchmark task: `libero_90/32`
- Parent task family: `libero_pick_place`
- Visible instruction: Put the ketchup in the top drawer of the cabinet.
