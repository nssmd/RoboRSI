...
domain: manipulation
version: 0.1.0
description: Put the frying pan on top of the cabinet.
metadata:
...
- Benchmark task: `libero_90/41`
- Parent task family: `libero_pick_place`
- Visible instruction: Put the frying pan on top of the cabinet.
