...
from roborsi.agent.skills import BUILTIN_SKILLS_DIR
from roborsi.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from roborsi.agent.tools.registry import ToolRegistry
...
class SubagentManager:
    ...
    def __init__(
        ...
        workspace: Path,
        announce: Callable[[InboundMessage], Awaitable[str]],
        model: str | None = None,
...
Summarize this naturally for the user. Keep it brief (1-2 sentences). Do not mention technical details like "subagent" or task IDs."""
    ...
    def _build_subagent_prompt(self) -> str:
        ...
        from roborsi.agent.context import ContextBuilder
        from roborsi.agent.skills import SkillsLoader
