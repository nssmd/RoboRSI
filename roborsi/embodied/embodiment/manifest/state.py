...
from roborsi.embodied.board.channels import CH_CONFIG
from roborsi.embodied.embodiment.manifest.guard import InterfaceGuard
...
from roborsi.embodied.embodiment.manifest.binding import Binding
from roborsi.embodied.embodiment.manifest.helpers import (
    _ARM_TYPES,
    _HAND_TYPES,
    _default_manifest,
