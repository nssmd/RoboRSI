...
from roborsi.embodied.embodiment.hardware.probers import _REGISTRY, get_prober
...
class HardwareDiscovery:
    ...
    def _probe_ports(
        ...
        """
        from roborsi.embodied.embodiment.hardware.scan import fix_serial_permissions
