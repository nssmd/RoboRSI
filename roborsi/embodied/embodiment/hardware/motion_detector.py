...
from roborsi.embodied.embodiment.hardware.motion import MOTION_THRESHOLD, detect_motion
...
class MotionDetector:
    ...
    def _read_positions(self) -> dict[int, int]:
        ...
        from roborsi.embodied.embodiment.hardware.probers import get_prober
