...
from roborsi.embodied.embodiment.hand.modbus import crc16, probe_modbus_slave_ids
from roborsi.embodied.embodiment.hand.registry import INSPIRE_RH56
...
class _ModbusSerial:
    ...
    def __init__(self, port: str, slave_id: int, baudrate: int = INSPIRE_RH56.baudrate):
        import serial  # pyserial — already a roborsi dependency
