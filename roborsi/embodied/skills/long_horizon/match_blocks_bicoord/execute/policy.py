"""long_horizon.match_blocks_bicoord.execute — retired direct entry point.
...
only so discover() registers ``match_blocks_bicoord.execute`` (the wiki +
...
def run(**_: Any) -> dict[str, Any]:
    raise NotImplementedError(
        "match_blocks_bicoord.execute is not directly runnable — long-horizon "
