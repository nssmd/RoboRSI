---
name: turn_switch.zeroshot
kind: atomic_subskill
parent: turn_switch
phase: zeroshot
version: 0.1.0
description: VLM uses base/robotwin tools to complete turn_switch. Successful trajectories persist to DataStore.
metadata:
