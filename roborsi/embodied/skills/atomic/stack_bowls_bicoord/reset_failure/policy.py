"""atomic.stack_bowls_bicoord.reset_failure — failure classify + recover + log."""
...
_TASK = "stack_bowls_bicoord"
_LABEL_PREFIX = "stack_bowls_bicoord_reset_failure"
...
def run(
    ...
    **_: Any,
    ...
    roll = Rollout(
        ...
        meta={"backend": "bicoord", "subskill": "reset_failure", "mode": mode},
    )
