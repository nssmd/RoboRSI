---
name: shake_bottle.zeroshot
kind: atomic_subskill
parent: shake_bottle
phase: zeroshot
version: 0.1.0
description: VLM uses base/robotwin tools to complete shake_bottle. Successful trajectories persist to DataStore.
metadata:
