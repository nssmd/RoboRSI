...
from roborsi.providers.base import GenerationSettings, LLMProvider, LLMResponse
...
def build_provider(config: Config) -> LLMProvider:
    ...
    stub_module = os.environ.get("ROBORSI_STUB_LLM")
    if stub_module and os.environ.get("ROBORSI_STUB"):
    ...
    if provider_name == "openai_codex" or model.startswith("openai-codex/"):
        ...
        if not provider_config or not provider_config.api_key or not provider_config.api_base:
            raise ProviderConfigurationError(
                ...
                "Set them in ~/.roborsi/config.json under providers.azure_openai section.",
            )
        ...
        from roborsi.providers.registry import find_by_name
        ...
        if (
            ...
            raise ProviderConfigurationError(
                ...
                "Set one in ~/.roborsi/config.json under providers section.",
            )
