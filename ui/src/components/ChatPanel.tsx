    ...
    >
      {compact ? (
        <div className="flex items-center justify-between gap-3 border-b border-[color:rgba(29,43,54,0.08)] px-4 py-4">
          <div>
            <div className="text-sm font-semibold text-tx">RoboRSI AI</div>
          ...
          >
            <div className="space-y-3">
              ...
              <div className={`${compact ? 'max-w-sm text-sm leading-6' : 'max-w-md text-sm leading-7'} text-tx2`}>
                Ask RoboRSI to inspect hardware state, suggest next recording steps, or summarize recent robot activity.
              </div>
            </div>
          </div>
        ) : (
                ...
                >
                  ...
                  >
                    {!compact && (
                      ...
                      >
                        <span>{isUser ? 'Operator' : 'RoboRSI'}</span>
